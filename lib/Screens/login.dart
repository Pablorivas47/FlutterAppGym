...
class _Login extends State<Login> {
  ...
  Widget build(BuildContext context){
    return Container(
      decoration: const BoxDecoration(//App background
              ...
              Center(
                child: Column(
                    children: <Widget>[
                      ...
                      Container( // textfield User/Email
                      ...
                      customGesture(// GestureDetector Forget Password
                        forgetPassword,
                      ...
                      CustomButton( //Button Continue with google
                        color: const Color(0xFF246B84), 
