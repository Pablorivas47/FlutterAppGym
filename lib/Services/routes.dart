...
final Map<String, WidgetBuilder > routes = {
    ...
    '/forgetPassword': (context) {return const ForgetPassword();},
    '/singUp': (context) {return const SignUp();},
    '/home': (context) {return const Home();},
    '/page404':(context) {return  const Page404();},
    '/routine':(context) {return  const Routine();},
    '/profile':(context) {return  const Profile();},
    '/customBotNavBar': (context) {return const CustomBottomNavigationBar();},
    '/customNavBar': (context) {return const CustomNavigationBar();},
    '/cNb': (context) {return const CustomNB();},
    '/personalInformation': (context) {return const PersonalInformation();},
    '/signInOut': (context) {return const SignInOut();},
};
